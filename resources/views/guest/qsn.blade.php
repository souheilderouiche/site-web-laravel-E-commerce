    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page page-about-us">
                <section class="halo-block halo-banner about-banner" data-banner-about data-item-to-show="1" data-item-dots="true" data-item-arrows="false" 
                data-item-dots-mb="true" data-item-arrows-mb="false">
                    <div class="container container-1570">
                        <div class="row">
                            <div class="halo-block-content col-12">
                                <div class="banner-item">
                                    <div class="img-box">
                                        <a href="#" class="image image-desktop image-adapt " style="padding-top: 49.04458598726115%;">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/About-1.jpg')}}" alt="Ella Banner">
                                        </a>
                                        <a href="#" class="image image-mobile image-adapt " style="padding-top: 114.7208121827411%;">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/slider_banner_mobile.jpg')}}" alt="Ella Banner">
                                        </a>
                                    </div>
                                    <div class="content-info content-box--absolute content-box--center content-box--full">
                                        <div class=" halo-row-slider">
                                            <div class="halo-row-item info text-center">
                                                <div class="avatar">
                                                    <div class="img-box">
                                                        <a href="#">
                                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/terminal-image.jpg')}}" alt="Ella Avatar">
                                                        </a>
                                                    </div>
                                                    <div class="content-avatar">
                                                        <h3 class="name"> Annie.L</h3>
                                                        <span class="position">Managing Director</span>
                                                    </div>
                                                </div>
                                                <div class="content">
                                                    <h3 class="title">Cosmo de Milance</h3>
                                                    <p class="desc">
                                                        Quisquemos sodales suscipit tortor ditaemcos condimentum de cosmo lacus meleifend menean diverra 
                                                        loremous. Nullam sit amet orci rutrum risus laoreet semper vel non magna. Mauris  vel sem a 
                                                        lectus vehicula accumsan et eleifend multricies...
                                                    </p>
                                                    <a href="#" class="button button-3">meet the team</a>
                                                </div>
                                            </div>
                                            <div class="halo-row-item info text-center">
                                                <div class="avatar">
                                                    <div class="img-box">
                                                        <a href="#">
                                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/contributor-image-1.png')}}" alt="Ella Avatar">
                                                        </a>
                                                    </div>
                                                    <div class="content-avatar">
                                                        <h3 class="name"> Jessica B.</h3>
                                                        <span class="position">Event Management</span>
                                                    </div>
                                                </div>
                                                <div class="content">
                                                    <h3 class="title">Cosmo de Milance</h3>
                ...
                <div class="page-header">
                    <div class="container container-1170">
                        <nav class="breadcrumb text-left ">
                            ...
                            <span class="bread-text">About us</span>
                        </nav>
                        <h3 class="page-title text-center uppercase">
                        about us
                        </h3>
                        <p class="desc text-center">
                        Cosmo lacus meleifend menean diverra loremous. Nullam sit amet orci rutrum risus laoreet semper vel
                        non magna. Mauris vel sem a lectus vehicula ultricies. Etiam semper sollicitudin lectus indous
                        scelerisque.
                        </p>
                    </div>
                </div><!-- End Header -->

                <section class="halo-block  about-policies">
                    <div class="container container-1170">
                        <div class="row"> 
                            <div class="halo-row-item col-4 text-center">
                                <div class="policies-icon">
                                    <div class="img-box">
                                        <a href="#">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/policy-1.jpg')}}" alt="Ella Policies">
                                        </a>
                                    </div>
                                </div>
                                <div class="policies-content">
                                    <span class="text-policies">Lorem De Dorus</span>
                                    <p class="desc">
                                        Nullam aliquet vestibulum augue non varius. Cras cosmo congue an melitos. Duis tristique del maliquam.
                                    </p>
                                    <a href="#" class="link-policies link link-underline">
                            ...
                            <div class="halo-row-item col-4 text-center">
                                <div class="policies-icon">
                                    <div class="img-box">
                                        <a href="#">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/policy-2.jpg')}}" alt="Ella Policies">
                                        </a>
                                    </div>
                                </div> 
                                <div class="policies-content">
                            ...
                            <div class="halo-row-item col-4 text-center">
                                <div class="policies-icon">
                                    <div class="img-box">
                                        <a href="#"><img src="{{asset('mainassets/assets/images/Pages/about-us/policy-3.jpg')}}" alt="Ella Policies"></a>
                                    </div>
                                </div>
                                <div class="policies-content">
                                    <span class="text-policies">Lorem De Dorus</span>
                ...
                </section> <!-- End policies -->

                <section class="halo-block about-store" data-slide-show  data-item-dots="true" data-item-arrows="true" data-item-dots-mb="true" data-item-arrows-mb="false">
                    <div class="container container-1170">
                        <div class="row halo-row-carousel">
                            <div class="store-item item-1">
                                <div class="store-left col-12 col-md-6">
                                    <div class="store-content">
                                        <h3 class="uppercase title">About Store</h3>
                                        <p class="desc">
                                            Quisquemos sodales suscipit tortor ditaemcos condimentum de cosmo lacus meleifend menean diverra
                                            loremous. Nullam sit amet orci rutrum risus laoreet semper vel non magna. Mauris vel sem a lectus
                                            vehicula ultricies. Etiam semper sollicitudin lectus indous scelerisque...
                                        </p>
                                        <a href="#" class="banner-button button button-1">
                                            Explore Shop
                                        </a>
                                    </div>
                                </div>
                                <div class="store-right animate-scale col-12 col-md-6 halo-block-video">
                                    <div class="img-box">
                                        <a href="#" class="image image-adapt " style="padding-top:114.8745519713262%">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/slider_banner_mobile_2.jpg')}}" alt="Ella Background Stores">
                                        </a>
                                    </div>
                                    <a class="link video_icon video_youtube" href="javascript:void(0);" aria-label="link" data-open-video="" data-video-banner="" data-video="_9VUPq3SxOc" role="button">
                            ...
                            <div class="store-item item-2">
                                <div class="store-right col-12 col-md-6">
                                    <div class="img-box">
                                        <a href="#" class="image animate-scale image-adapt" style="padding-top:114.8745519713262%">
                                            <img src="{{asset('mainassets/assets/images/Pages/about-us/slider_banner_mobile.jpg')}}" alt="Ella Stores">
                                        </a>
                                    </div>
                                </div>
                                <div class="store-left col-12 col-md-6">
                ...
                <section class="halo-block halo-banner about-contact">
                    <div class="container container-1570">
                        <div class="row">
                            <div class="contact-img col-12 col-xl-6">
                                <div class="img-box">
                                    <a href="#" class="image image-adapt animate-scale" style="padding-top: 85.17241379310345%;">
                                        <img src="{{asset('mainassets/assets/images/Pages/about-us/contact.jpg')}}" alt="Ella Contact">
                                    </a>
                                </div>
                            </div>
                            <div class="col-12 col-xl-6 wrapper-street">
                                <div class="contact-street" style="width:100%;height:100%;">
                                    <div class="content-left">
                                        <h3 class="title uppercase">contact us</h3>
                                        <div class="wrapper-text">
                                            <div class="massage-contact">
                                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="comment-alt-dots" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-comment-alt-dots fa-w-16 fa-7x">
                                                    <path fill="currentColor" d="M448 0H64C28.7 0 0 28.7 0 64v288c0 35.3 28.7 64 64 64h96v84c0 9.8 11.2 15.5 19.1 9.7L304 416h144c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64zM128 240c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm128 0c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm128 0c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"></path>
                                                </svg>
                                                <span>TEXT: 091-123-ELLA</span>
                                            </div>
                                            ...
                                            <p class="street desc">
                                                685 Market Street<br> San Francisco, CA 94105,<br>United States
                                            </p>
                                            <p class="time desc">
                                                Opening Hours<br>MON to SAT: 9:00 AM - 10:00 PM<br>SUN: 10:00 AM - 6:00 PM
                                            </p>
                                        </div>
                                    </div> 
                                    <div class="content-right">
                                        ...
                                        <a href="/guest/contact" class="button button-1">
...
<!-- Mirrored from themes.halothemes.com/html/ella-html-demo/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:30:38 GMT -->
</html>