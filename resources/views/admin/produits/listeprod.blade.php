...
<!-- Mirrored from vetra.laborasyon.com/demos/default/user-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 15:59:15 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                <div class="d-none d-md-flex">Catégories</div>
                <div class="d-md-flex gap-4 align-items-center">
        ...
        <table id="users" class="table table-custom table-lg">
          ...
          @foreach($produit as $prod)
            <tr>
                ...
                <td>{{$prod->id}}</td>
                <td> <img src="{{asset('uploads')}}/{{$prod->image}}" width="150"></td>
                <td>{{$prod->name}}</td>
                ...
                <td class="text-end">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="/admin/produits/detaille/{{$prod->id}}" class="dropdown-item">Détaille</a>
                            <a href="/admin/produits/modifier/{{$prod->id}}" class="dropdown-item">Modifier</a>
                            <a href="/admin/produits/delete/{{$prod->id}}" class="dropdown-item text-danger">Supprimer</a>
                        </div>
                    </div>
                </td>
            </tr>
