<div class="header-wrapper">
    ...
    <div class="header-right header-icon text-right">
        <div class="header__iconItem header__group">
            ...
            <a class="header__icon  header__link--account link-underline" id="customer_login_link" href="/client/dashboard">
            ...
            <a href="/client/cart" class="header__icon header__icon--cart link link-underline focus-inset" id="cart-icon-bubble" data-open-cart-sidebar>
                ...
                <div class="cart-count-bubble">
                    <span class="text-count" aria-hidden="true" data-cart-count="">{{$nblc}}</span><span class="visually-hidden">0 items</span>
                </div>
            </a>
