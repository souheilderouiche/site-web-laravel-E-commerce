    ...
    <div class="profile-cover bg-image mb-4" data-image="{{asset('dashassets/assets/images/profile-bg.jpg')}}">
        <div
            ...
            <div class="ms-md-auto">
                <a href="#edit_admin" class="btn btn-primary btn-lg btn-icon">
                ...
                <form action="/admin/profil/update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="name_ad" value="{{auth()->user()->name}}">
                               @error('name_ad')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="email_ad" value="{{auth()->user()->email}}">
                               @error('email_ad')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="password" step="any"class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="pw_ad" >
                               @error('pw_ad')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="img_ad" >
                               @error('img_ad')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
