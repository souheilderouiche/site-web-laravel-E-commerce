                    ...
                    <form action="/produit/Add"method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="name_prod">
                                   @error('name_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleInputPassword1" name="desc_prod"></textarea>
                            @error('desc_prod')
                                    <span>{{$message}}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="qt_prod">
                                   @error('qt_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" step="any"class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="prix_prod">
                                   @error('prix_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="img_prod">
                                   @error('img_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
