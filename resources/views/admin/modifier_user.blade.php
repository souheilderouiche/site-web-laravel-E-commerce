                    ...
                    <form action="/user/update"method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="name_user" value="{{$user->name}}">
                                   @error('name_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="email_user" {{$user->email}}>
                                   @error('qt_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="password" step="any"class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="pw_user">
                                   @error('prix_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select type="text" step="any"class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="role_user">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="img_user">
                                   @error('img_prod')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
