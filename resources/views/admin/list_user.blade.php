        ...
        <table id="users" class="table table-custom table-lg">
          ...
          @foreach($users as $user)
            <tr>
                ...
                <td>{{ $user->id}}</td>
                <td> <img src="{{asset('uploads')}}/{{ $user->image}}" width="100"></td>
                <td>{{ $user->name}}</td>
                <td>{{ $user->email}}</td>
                <td>{{ $user->role}}</td>
                ...
                <td class="text-end">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="/admin/mod_user/{{$user->id}}" class="dropdown-item">Modifier</a>
                            <a href="/admin/delete_user/{{$user->id}}" class="dropdown-item text-danger">Supprimer</a>
                        </div>
                    </div>
                </td>
            </tr>
