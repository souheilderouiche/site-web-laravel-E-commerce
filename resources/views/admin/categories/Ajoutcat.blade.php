...
@include('inc.admin.header')
    ...
    <div class="row">
        <div class="order-2 order-lg-1 col-lg-9 bd-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/catégorie/Add"method="post">
                        @csrf 
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Name</label>
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="name_cat">
                                   @error('name_cat')
                                    <span>{{$message}}</span>
                                   @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleInputPassword1" name="desc_cat"></textarea>
                            @error('desc_cat')
                                    <span>{{$message}}</span>
                            @enderror
                        </div>
