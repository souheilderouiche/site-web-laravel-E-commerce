                ...
                <td class="text-end">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="/admin/categories/detaille/{{$cat->id}}" class="dropdown-item">Détaille</a>
                            <a href="/admin/categories/modifier/{{$cat->id}}" class="dropdown-item">Modifier</a>
                            <a href="/admin/categories/delete/{{$cat->id}}" class="dropdown-item text-danger">Supprimer</a>
                        </div>
                    </div>
                </td>
            </tr>
