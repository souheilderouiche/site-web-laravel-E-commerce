...
<!-- Mirrored from themes.halothemes.com/html/ella-html-demo/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:12:49 GMT -->
...
<body class="template-index skin-6">
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="halo-block halo-block-slideshow" data-slide-show  data-item-dots="true" data-item-arrows="false" data-item-dots-mb="true" data-item-arrows-mb="false">
                <div class="container container-1770">
                    <div class="halo-block-content halo-row-carousel">
                        ...
                        <div class="bannerCarousel-slide slide-item">
                            <div class="img-box img-box--mobile">
                                <a href="category-full-width.html" class="image image-adapt " style="padding-top: 40.677966101%;">
                                    <img src="{{asset('uploads/')}}/{{($prod->image)}}" alt="Ella - HTML Template">
                                </a>
                                <a href="category-full-width.html" class="image image-mobile image-adapt" style="padding-top: 136.36363636363637%">
            ...
            </div><!-- END: Halo Block Slide Show -->

            <div class="halo-block halo-block-four-banner">
                <div class="container container-1770">
                    <div class="row">
                        <div class="halo-row-item col-12 col-md-6">
                            <div class="img-box">
                                <a href="#" class="image animate-scale image-adapt" style="padding-top: 83.2%">
                                    <img src="{{asset('mainassets/assets/images/banners/home/home-6/banner-1.jpg')}}" alt="Ella - HTML Template">
                                </a>
                            </div>
                        </div>
                        <div class="halo-row-item col-12 col-md-6">
                            <div class="halo-row-item halo-row-2item">
                                <div class="img-box">
                                    <a href="#" class="image animate-scale image-adapt" style="padding-top: 39.655172413%">
                                        <img src="{{asset('mainassets/assets/images/banners/home/home-6/banner-2.jpg')}}" alt="Ella - HTML Template">
                                    </a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="halo-row-item col-banner col-6">
                                    <div class="img-box">
                                        <a href="#" class="image animate-scale image-adapt" style="padding-top: 82.380952381%">
                                            <img src="{{asset('mainassets/assets/images/banners/home/home-6/banner-3.jpg')}}" alt="Ella - HTML Template">
                                        </a>
                                    </div>
                                </div>
                                <div class="halo-row-item col-banner col-6">
                                    <div class="img-box">
                                        <a href="#" class="image animate-scale image-adapt" style="padding-top: 82.380952381%">
                                            <img src="{{asset('mainassets/assets/images/banners/home/home-6/banner-4.jpg')}}" alt="Ella - HTML Template">
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            </div><!-- END: Halo Block Four Banner -->
            ...
            <section class="halo-block halo-product-block">
                <div class="container container-1170">
                    <div class="halo-block-header text-center">
                        ...
                        <a href="#" class="view_allcapitalize link-underline">
                    ...
                    <div class="halo-block-content">
                        <div class="row">
                            ...
                            @foreach($produits as $prod)
                              @if($i < 4)
                               <div class="halo-row-item product-item col-6 col-md-6 col-lg-3">
                                <div class="product-card">
                                    <div class="product-card-top">
                                        <div class="product-card-media">
                                            <a href="/produit/detaille/{{$prod->id}}" class="animate-scale image image-adapt" style="padding-bottom: 110.526315789%">
                                                <img src="{{asset('uploads')}}/{{$prod->image}}" alt="Halo Product">
                                            ...
                                            <div class="card-product__group group-left">
                                                ...
                                                <div class="card-product__group-item card-quickview card-quickviewIcon">
                                                    <a class="card-icon quickview-icon" href="/produit/detaille/{{$prod->id}}" >
                                            ...
                                            <div class="card-action">
                                                <a href="/produit/detaille/{{$prod->id}}"  class="button button-ATC text-center">
                                                    <span class="text">Détaille</span></span>
                                                </a>
                                    ...
                                    <div class="product-card-bottom">
                                        <div class="product-card-information text-center">
                                            <div class="card-vendor uppercase">
                                                <a href="#" title="Sodling" tabindex="0">{{$prod->name}}</a>
                                            </div>
                                            ...
                                            <div class="card-price">
                                                <div class="price-item">
                                                    <span class="money">{{$prod->prix}} TDN</span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="product-infinite-scroll text-center" data-product-infinite="">
                        <a class="button button-2" data-collection="" data-limit="" data-page="" data-total="" data-image-ratio="adapt" href="#" >
                            <span>Show More</span>
                        </a>
                    </div>
                </div>
                                ...
                                <div class="product-card">
                                    <div class="product-card-top">
                                        <div class="product-card-media">
                                            ...
                                            <div class="card-product__group group-left">
                                                ...
                                                <div class="card-product__group-item card-quickview card-quickviewIcon">
                                                    <a class="card-icon quickview-icon" href="javascript:void(0)" data-product-id="" data-open-quick-view-popup="" data-product-handle="" tabindex="0" href="/produit/detaille/{{$prod->id}}">
                                                        <span class="visually-hidden">Quick View</span>
                                                        <span class="text">Quick View</span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" aria-hidden="true" focusable="false" role="presentation" class="icon icon-eyes">
                                                            <path d="M508.745,246.041c-4.574-6.257-113.557-153.206-252.748-153.206S7.818,239.784,3.249,246.035
                                            ...
                                            <div class="card-action">
                                                <form action="http://themes.halothemes.com/cart/add" method="post" class="variants" data-product-id="" enctype="multipart/form-data">
                                                    <a class="button button-ATC text-center" href="javascript:void(0)" data-quickshop-popup="">Quick Add</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-card-information text-center">
                                            ...
                                            <a href="/produit/detaille/{{$prod->id}}" class="card-title link-underline card-title-ellipsis">
                                                <span class="text">Détaille</span>
                                            </a>
                                            <div class="productView-rating">
                                                <span class="spr-badge"  data-rating="0.0">
                                                    <span class="spr-starrating spr-badge-starrating">
                        ...
                        <div class="halo-product-block product-edit-item product-edit-itemFirst clearfix" data-cart-edit-id="" data-position="0">
                            <div class="product-edit-itemLeft">
                                <a class="product-edit-image" href="#">
                                    <img src="assets/images/banners/home/home-6/product-image-11.jpg" alt="Halo Product">
                                </a>
                            </div>
                                ...
                                <div class="product-edit-options halo-productOptions">
                                    <div class="productView-variants halo-productOptions">
                                        ...
                                        <div class="product-form__inputs">
                                            ...
                                            <label class="product-form__label soldout" for="option-66176314901233-edit-size-s">
                        ...
                        <div class="productView-images-wrapper">
                            ...
                            <div class="productView-nav" data-arrow="false">
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-11.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-11.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-11.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-12.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-12.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-12.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-13.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-13.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-13.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-14.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-14.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-14.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-3.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-3.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-3.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-4.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-4.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-4.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-5.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-5.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-5.jpg" alt="Product Image">
                                    </div>
                                </div>
                                <div class="productView-image">
                                    <div class="media image-zoom" data-zoom-image="./assets/images/banners/home/home-6/product-image-6.jpg" data-fancybox="gallery-qv" data-src="assets/images/banners/home/home-6/product-image-6.jpg">
                                        <img src="assets/images/banners/home/home-6/product-image-6.jpg" alt="Product Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="halo-compareColors-swatch halo-productOptions">
                            <ul class="compareColors-list list-unstyled text-left">
                                <li class="item">
                                    ...
                                    <label class="swatch-compare-color-label" title="Pink" data-variant-img="./assets/images/banners/home/home-6/product-image-5.jpg" for="quickView-swatch-compare-color-cadetblue">
                                ...
                                <li class="item">
                                    ...
                                    <label class="swatch-compare-color-label" title="Blue" data-variant-img="./assets/images/banners/home/home-6/product-image-6.jpg" for="quickView-swatch-compare-color-blue">
                                ...
                                <li class="item">
                                    ...
                                    <label class="swatch-compare-color-label" title="Mediumseagreen" data-variant-img="./assets/images/banners/home/home-6/product-image-7.jpg" for="quickView-swatch-compare-color-pink">
                                        <span class="pattern" style="background-color: mediumseagreen;"></span>
                                    </label>
                                </li>
                                <li class="item">
                                    ...
                                    <label class="swatch-compare-color-label" title="Moccasin" data-variant-img="./assets/images/banners/home/home-6/product-image-8.jpg" for="quickView-swatch-compare-color-red">
                                        <span class="pattern" style="background-color: moccasin;"></span>
                                    </label>
                                </li>
                            </ul>
            ...
            <div class="halo-popup-wrapper">
                ...
                <div class="halo-popup-content halo-product-block custom-scrollbar">
                    <div class="halo-productView-left">
                        <div class="productView-image">
                            <a class="image" href="#">
                                <img src="assets/images/banners/home/home-6/product-image-6.jpg" alt="Halo Product">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="product-edit-options productView-variants ">
                            <div class="halo-productOptions">
                                ...
                                <div class="product-form__inputs">
                                    ...
                                    <label class="product-form__label soldout" for="option-66176314901233-quick-add-size-s">
                                        <span class="text">S</span>
                                    </label>
                                ...
                                <div class="product-form__input">
                                    ...
                                    <input class="product-form__radio" type="radio" checked id="option-66176314901241-material-quick-add-option-1" name="option-quick-add-material" value="Option 1">
                                    <label class="product-form__label available " for="option-66176314901241-material-quick-add-option-1">
                                        <span class="text">Option 1</span>
                                    </label>
                                    <input class="product-form__radio" type="radio" id="option-66176314901242-material-quick-add-option-2" name="option-quick-add-material" value="Option 2">
                                    <label class="product-form__label available" for="option-66176314901242-material-quick-add-option-2">
                                        <span class="text">Option 2</span>
                                    </label>
                                    <input class="product-form__radio" type="radio" id="option-66176314901243-material-quick-add-option-3" name="option-quick-add-material" value="Option 3">
                                    <label class="product-form__label available" for="option-66176314901243-material-quick-add-option-3">
                                        <span class="text">Option 3</span>
                                    </label>
                                </div>
                            </div>
        ...
        <div class="halo-popup halo-notify-popup customPopup-small" data-notify-popup id="halo-notify-popup">
            <div class="halo-popup-wrapper">
                <div class="halo-popup-header customPopup-header">
                    <a href="javascript:void(0)" class="halo-popup-close close-notify-popup customPopup-close clearfix" data-close-notify-popup role="button">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" aria-hidden="true" focusable="false" role="presentation">
                        <path d="M 38.982422 6.9707031 A 2.0002 2.0002 0 0 0 37.585938 7.5859375 L 24 21.171875 L 10.414062 7.5859375 A 2.0002 2.0002 0 0 0 8.9785156 6.9804688 A 2.0002 2.0002 0 0 0 7.5859375 10.414062 L 21.171875 24 L 7.5859375 37.585938 A 2.0002 2.0002 0 1 0 10.414062 40.414062 L 24 26.828125 L 37.585938 40.414062 A 2.0002 2.0002 0 1 0 40.414062 37.585938 L 26.828125 24 L 40.414062 10.414062 A 2.0002 2.0002 0 0 0 38.982422 6.9707031 z"></path>
                        </svg>
                    </a>
                ...
                <div class="site-nav-mobile nav" data-navigation-mobile>
                    <ul class="list-menu list-menu--inline list-unstyled"  id="MenuMobileListSection-menu" data-heading="Menu">
                        ...
                        <li class="menu-lv-item menu-lv-1 text-left no-megamenu dropdown">
                            <a href="#" class="menu-lv-1__action list-menu__item menu_mobile_link link focus-inset  menu-lv__flex">
                                <span class="custom-icon style-circle">
                                    <img src="{{asset('mainassets/assets/images/menu-mobile/lv-1-4.png')}}" alt="Blog">
                                </span>
                    ...
                    <div>
                        <form method="post" action="http://themes.halothemes.com/localization" id="HeaderLanguageForm-mb" accept-charset="UTF-8" class="div" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization"><input type="hidden" name="utf8" value="✓"><input type="hidden" name="_method" value="put"><input type="hidden" name="return_to" value="/">
                            ...
                            <div class="disclosure">
                                <p class="title" id="HeaderLanguageLabel-mb">Language</p>
        ...
        <div class="halo-sidebar halo-sidebar-right halo-sidebar_language_currency" data-language_currency-sidebar id="sidebar_language_currency">
            <div class="halo-sidebar-header text-left">
                <a href="#" class="halo-sidebar-close" data-close-language_currency-sidebar="" title="Close">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                            <path d="M 38.982422 6.9707031 A 2.0002 2.0002 0 0 0 37.585938 7.5859375 L 24 21.171875 L 10.414062 7.5859375 A 2.0002 2.0002 0 0 0 8.9785156 6.9804688 A 2.0002 2.0002 0 0 0 7.5859375 10.414062 L 21.171875 24 L 7.5859375 37.585938 A 2.0002 2.0002 0 1 0 10.414062 40.414062 L 24 26.828125 L 37.585938 40.414062 A 2.0002 2.0002 0 1 0 40.414062 37.585938 L 26.828125 24 L 40.414062 10.414062 A 2.0002 2.0002 0 0 0 38.982422 6.9707031 z"></path>
                        </svg>
                </a>
            ...
            <div class="halo-sidebar-wrapper">
                <div class="site-nav-mobile nav-currency-language">
                    <div>
                        <form method="post" action="http://themes.halothemes.com/localization" id="HeaderLanguageForm" accept-charset="UTF-8" class="div" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization"><input type="hidden" name="utf8" value="✓"><input type="hidden" name="_method" value="put"><input type="hidden" name="return_to" value="/">
                            <div class="no-js-hidden">
                            <div class="disclosure">
                    ...
                    <div class="currency-menu" id="language-currency-mobile">
                        <p class="title title-sidebar">Currency</p>
                        <div class="wrapper-currencies">
                            <a class="currency-item active " href="#" data-currency="USD">
                                <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" version="1.1"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
...
<!-- Mirrored from themes.halothemes.com/html/ella-html-demo/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:15:48 GMT -->
</html>