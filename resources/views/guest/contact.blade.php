...
<!-- Mirrored from themes.halothemes.com/html/ella-html-demo/contact-us-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:30:52 GMT -->
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page page-contact-2 ">
                    ...
                    <div class="container container-1170">
                        <div class="page-header">
                            <nav class="breadcrumb breadcrumb-center justify-start text-center ">
                                ...
                                <span class="bread-text">Contact Us 2</span>
                            </nav>
                ...
                <div class="contact-navigation scroll-snap-mobile disable-srollbar">
                    <ul class="nav disable-scrollbar">
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">General</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">Shipping</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">Returns Policy</span>  </a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">GDPR Information</span> </a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">Privacy Policy</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">Terms Conditions</span> </a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" class="link-underline"> <span class="text">About us</span> </a>
                        </li>
                        <li class="item ">
                            <a href="#" class="link-underline"> <span class="text">Contact us</span> </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="contact-form">
                                <form method="post" action="#" accept-charset="UTF-8" class="contact-form">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input class="form-input form-input-placeholder" type="text" name="contact[name]">
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label">Your Phone</label>
                                        <input class="form-input form-input-placeholder" type="tel" name="contact[phone]">
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" >Your Email<span class="red-asterisk">*</span></label>
                                        <input class="form-input form-input-placeholder" type="email" name="contact[email]" value="">
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" >Your Comment<span class="red-asterisk">*</span></label>
                                        <textarea class="form-input form-input-hiddenPlaceholder" rows="8" name="contact[body]"></textarea>
                                    </div>
                                    <div class="form-actions">
                                        <input type="submit" class="button button-1" value="Submit Contact">
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="contact-map">
                    <div class="container container-1170">
                        <div class="map-header text-center">
                            ...
                            <p class="desc">
                                We have 06 stores throughout “Country” and more in works. Complete the search details below to find a Ella store near you.
                            </p>
                            <a href="#" class="button button-2">
                                Find A Store
                            </a>
                    ...
                    <div class="iframe">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.9340444904806!2d106.71818441533426!3d10.816359461411732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175289c3683f2a7%3A0xf8213d8614e6f0b0!2zVGhhbmggxJBhLCBDxrAgeMOhIFRoYW5oIMSQYSwgcGjGsOG7nW5nIDI3LCBCw6xuaCBUaOG6oW5oLCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1647592510766!5m2!1svi!2s" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </main>
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card-bottom">
                                                ...
                                                <div class="card-swatch text-center clearfix">
                                                    <ul class="swatch list-unstyled">
                                                        <li class="item">
                                                            <label  class="swatch-label is-active" data-value="Green" data-variant-id>
                                                                <span class="pattern" style="background-color: mediumseagreen">
                                                                </span>
                                                            </label>
                                                        </li>
                                                        <li class="item">
                                                            <label  class="swatch-label is-active" data-value="Orange" data-variant-id>
                                                                <span class="pattern" style="background-color: moccasin">
                                                                </span>
                                                            </label>
                                                        </li>
        ...
        <div class="halo-sidebar halo-sidebar-left halo-sidebar_menu" data-menu-sidebar id="halo-menu-sidebar">
            ...
            <div class="halo-sidebar-wrapper custom-scrollbar">
                ...
                <div class="site-nav-mobile nav-currency-language">
                    <div>
                        <form method="post" action="http://themes.halothemes.com/localization" id="HeaderLanguageForm-mb" accept-charset="UTF-8" class="div" enctype="multipart/form-data">
                                        ...
                                        <div class="product-card-information text-left">
                                            ...
                                            <div class="card-swatch text-center clearfix">
                                                <ul class="swatch list-unstyled">
                                                    ...
                                                    <li class="item">
                                                        <label  class="swatch-label" data-value="moccasin" data-variant-id>
                                                            <span class="pattern" style="background-color: moccasin"></span>
                                                        </label>
                                                    </li>
                                                </ul>
            ...
            <div class="halo-popup-wrapper">
                ...
                <div class="halo-popup-content">
                    <a class="product-image" href="#">
                        <img src="assets/images/card-product/img-22.jpg" alt="hallo-product">
                    </a>
...
<!-- Mirrored from themes.halothemes.com/html/ella-html-demo/contact-us-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 22:30:54 GMT -->
</html>