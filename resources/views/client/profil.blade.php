...
<!-- Mirrored from vetra.laborasyon.com/demos/default/profile-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 15:59:14 GMT -->
<head>
    <meta charset="UTF-8">
...
<!-- ./ header -->
    ...
    <div class="profile-cover bg-image mb-4" data-image="{{asset('dashassets/assets/images/profile-bg.jpg')}}">
        <div
            ...
            <div class="avatar avatar-xl me-3">
                <img src="{{asset('uploads')}}/{{auth()->user()->image}}" class="rounded-circle"
                     alt="...">
            </div>
            ...
            <div class="ms-md-auto">
                <a href="#edit_client" class="btn btn-primary btn-lg btn-icon">
    ...
    <div class="card" id="edit_admin">
        <div class="card-body">
            <div class="mt-4" >
                <form action="/client/profil/update" method="post" enctype="multipart/form-data">
                    @csrf 
                    
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Name</label>
                        <input type="text" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="name_cl" value="{{auth()->user()->name}}">
                               @error('name_cl')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="email_cl" value="{{auth()->user()->email}}">
                               @error('email_cl')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="password" step="any"class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="pw_cl" >
                               @error('pw_ad')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" name="img_cl" >
                               @error('img_cl')
                                <span>{{$message}}</span>
                               @enderror
                    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex align-items-center px-0">
                            <figure class="avatar avatar-state-primary me-3">
                                <img src="{{asset('dashassets/assets/images/user/women_avatar5.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </figure>
                            <div class="flex-fill">
                        ...
                        <li class="list-group-item d-flex align-items-center px-0">
                            <figure class="avatar avatar-state-secondary me-3">
                                <img src="{{asset('dashassets/assets/images/user/man_avatar1.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </figure>
                            <div class="flex-fill">
                        ...
                        <li class="list-group-item d-flex align-items-center px-0">
                            <figure class="avatar avatar-state-success me-3">
                                <img src="{{asset('dashassets/assets/images/user/women_avatar1.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </figure>
                            <div class="flex-fill">
                        ...
                        <li class="list-group-item d-flex align-items-center px-0">
                            <figure class="avatar avatar-state-warning me-3">
                                <img src="{{asset('dashassets/assets/images/user/women_avatar2.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </figure>
                            <div class="flex-fill">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="avatar-group me-2">
                            ...
                            <a href="#" class="avatar" data-bs-toggle="tooltip" title="Malanie Hanvey">
                                <img src="{{asset('dashassets/assets/images/user/man_avatar2.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </a>
                            ...
                            <a href="#" class="avatar" data-bs-toggle="tooltip" title="Kenneth Hune">
                                <img src="{{asset('dashassets/assets/images/user/women_avatar3.jpg')}}" class="rounded-circle"
                                     alt="image">
                            </a>
                        </div>
                        <span>+7 people</span>
...
<!-- Mirrored from vetra.laborasyon.com/demos/default/profile-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 15:59:15 GMT -->
</html>
